...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td align="center">
        <p align="justify">Sistema de gerenciamento de banco de dados relacional, open source, conhecido por sua robustez, conformidade com padrões SQL e suporte a dados complexos.</p>
    </tr>
    <tr>
      <td align="center">
...
- 📱 **[Jogo Termo](https://github.com/Adler-Pereira/termo)**  
  Um projeto pessoal que recria o famoso jogo Termo. **[HTML, CSS, JavaScript e Java (AWS Lambda e API Spring Boot na Render)]**.

- ⚖️ **[Balança de Pratos](https://github.com/Adler-Pereira/balanca-de-pratos)**  
  Um projeto escolar que demonstra de maneira didática o conceito de equivalência em uma equação matemática. **[HTML, CSS e Javascript].**
  
- 👨‍👩‍👧‍👦 **[Árvore Genealógica](https://github.com/Adler-Pereira/arvore-genealogica)**  
  Um projeto de tecnólogo que utiliza de conceitos de estrutura de dados para construir uma árvore genealógica, utilizando nós e listas. **[Java].**
  
- 📋 **[Simporg](https://github.com/Adler-Pereira/simporg-ui) [Em andamento]**  
  Simporg é uma aplicação web que simplifica a organização de tarefas e projetos por meio de uma API moderna e eficiente. **[HTML, CSS e Javascript].**
